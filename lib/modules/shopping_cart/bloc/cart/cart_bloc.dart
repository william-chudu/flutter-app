    ...
    on<GetItemsCart>((GetItemsCart event, Emitter<CartState> emit) async {
      try {
        ...
        final CartState newState = await compute((String path) async {
          ...
          final List<RoomRateInfo?> roomRate = await Future.wait(box.values.map((item) async {
            ...
            final Map<String, dynamic>? room = json['data']['arrLoaiPhongDisplayAble'].firstWhere(
